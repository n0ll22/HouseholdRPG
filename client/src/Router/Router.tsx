...
//Itt található milyen útvonalakon lehet navigálni az böngészőn belül
const Router: React.FC = () => {
  const auth = useContext(AuthContext);
  const { consent, accept } = useCookieConsent();

  if (!auth) return <p>Error: AuthContext not available</p>;
  ...
  const router = createBrowserRouter([
    {
      ...
      element: (
        <>
          {/* Cookie banner shown above everything, interactive */}
          ...
          {/* Main app content with blur and disabled interactions if consent not given */}
          <div
          ...
          ? [
              ...
              { path: "taskComplete", element: <TaskCounterPage /> },
              {
                ...
                children: [
                  ...
                  { path: "list/tutorial/:id", element: <TaskTutorial /> },
                  { path: "edit", element: <EditTask /> },
                  { path: "edit/:id", element: <EditTaskDetail /> },
